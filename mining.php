...
echo "<table class='table table-bordered' id='dataTable12' width='100%' cellspacing='0'>";
echo "<thead>";
echo "<tr>
                            <th>No</th>
                            <th>Item</th>
...
echo "<div class='card-header py-3'>
    <h6 class='m-0 font-weight-bold text-primary'>Itemset 1 yang lolos</h6>
</div>";
echo "<div class='card-body'>";
echo "<div class='table-responsive'>";

echo "<table class='table table-bordered' id='dataTable13' width='100%' cellspacing='0'>";
echo "<thead>";
echo "<tr>
                    <th>No</th>
                    <th>Item</th>
...
echo "<table class='table table-bordered' id='dataTable14' width='100%' cellspacing='0'>";
echo "<thead>";
echo "<tr>
                            <th>No</th>
                            <th>Item1</th>
...
echo "<div class='card-header py-3'>
        <h6 class='m-0 font-weight-bold text-primary'>Itemset 2 yang lolos</h6>
    </div>";
echo "<div class='card-body'>";
echo "<div class='table-responsive'>";

echo "<table class='table table-bordered' id='dataTable15' width='100%' cellspacing='0'>";
echo "<thead>";
echo "<tr>
                            <th>No</th>
                            <th>Item 1</th>
...
echo "<div class='card-header py-3'>
        <h6 class='m-0 font-weight-bold text-primary'>Association Rules</h6>
    </div>";
echo "<div class='card-body'>";
echo "<div class='table-responsive'>";

echo "<table class='table table-bordered' id='dataTableRules' width='100%' cellspacing='0'>";
echo "<thead>";
echo "<tr>
        <th>No</th>
        <th>Rule</th>
...
$no = 1;
foreach ($itemset2_var1 as $key => $value) {
    $confidence = ($supportItemset2[$key] / $supportItemset1[array_search($itemset2_var1[$key], $itemset1)]) * 100;

    if ($confidence >= $min_confidence) {
        $keterangan = "Jika wisatawan asal " . $itemset2_var1[$key] . " berkunjung ke Indonesia maka wisatawan " . $itemset2_var2[$key] . " juga ikut berkunjung ke Indonesia karena keindahan alam Indonesia.";
    } else {
        $keterangan = "Negara " . $itemset2_var1[$key] . " dan " . $itemset2_var2[$key] . " nilai kepercayaan wisata di Indonesia kurang, perlu dilakukan peninjauan lebih lanjut.";
    }

    echo "<tr>";
    echo "<td>" . $no . "</td>";
    echo "<td>" . $itemset2_var1[$key] . " => " . $itemset2_var2[$key] . "</td>";
    echo "<td>" . price_format($confidence) . "</td>";
...
echo "</div>";
    ...
    echo "<table class='table table-bordered' id='dataTable16' width='100%' cellspacing='0'>";
    echo "<thead>";
    echo "<tr>
                            <th>No</th>
                            <th>Item1</th>
        ...
        while ($b < count($itemset2_var1)) {
            if ($a != $b) {
                ...
                if (!empty($itemset1a) && !empty($itemset1b) && !empty($itemset2a) && !empty($itemset2b)) {
                    ...
                    $temp_array = get_variasi_itemset3($tigaVariasiItem, $itemset1a, $itemset1b, $itemset2a, $itemset2b);
    ...
    echo "<div class='card-header py-3'>
            <h6 class='m-0 font-weight-bold text-primary'>Itemset 3 yang lolos</h6>
        </div>";
    echo "<div class='card-body'>";
    echo "<div class='table-responsive'>";

    echo "<table class='table table-bordered' id='dataTable17' width='100%' cellspacing='0'>";
    echo "<thead>";
    echo "<tr>
                                <th>No</th>
                                <th>Item 1</th>
    ...
    //dari itemset 3 jika tidak ada yg lolos ambil dari itemset 2 jika tidak ada gagal mendapatkan confidence
    ...
    if ($jumlah_itemset3_lolos > 0) {
        ...
        while ($row_3 = $db_object->db_fetch_array($res_3)) {
            ...
            // Insert into itemset3 one query with many values
            $value_insert_itemset3 = implode(",", $valueIn_itemset3);
            $sql_insert_itemset3 = "INSERT INTO itemset3 (atribut1, atribut2, atribut3, jumlah, support, lolos, id_process) "
                . " VALUES " . $value_insert_itemset3;
            $db_object->db_query($sql_insert_itemset3);
            
            // Calculate association rules and confidence for itemset3
            echo "<div class='container-fluid mt-3'>
                <!-- Page Heading -->
                <h1 class='h3 mb-2 text-gray-800'></h1>
                <p class='mb-4'> </p>
                ...
                <div class='card shadow mb-4'>";
            echo "<div class='card-header py-3'>
                    <h6 class='m-0 font-weight-bold text-primary'>Association Rules (Itemset 3)</h6>
                </div>";
            echo "<div class='card-body'>";
            echo "<div class='table-responsive'>";
    
            echo "<table class='table table-bordered' id='dataTableRules3' width='100%' cellspacing='0'>";
            echo "<thead>";
            echo "<tr>
                                    <th>No</th>
                                    <th>Rule</th>
            ...
            $no = 1;
            foreach ($itemset3_var1 as $key => $value) {
                $confidence = ($supportItemset3[$key] / $supportItemset2[array_search(array($itemset3_var1[$key], $itemset3_var2[$key]), $itemset2_var1)]) * 100;
    
                if ($confidence >= $min_confidence) {
                    $keterangan = "Jika wisatawan asal " . $itemset3_var1[$key] . " dan " . $itemset3_var3[$key] . " berkunjung ke Indonesia maka wisatawan " . $itemset3_var2[$key] . " juga ikut berkunjung ke Indonesia karena keindahan alam Indonesia.";
                } else {
                    $keterangan = "Negara " . $itemset3_var1[$key] . ", " . $itemset3_var3[$key] . ", dan " . $itemset3_var2[$key] . " nilai kepercayaan wisata di Indonesia kurang, perlu dilakukan peninjauan lebih lanjut.";
                }
    
                echo "<tr>";
                echo "<td>" . $no . "</td>";
                echo "<td>" . $itemset3_var1[$key] . " dan " . $itemset3_var3[$key] . " => " . $itemset3_var2[$key] . "</td>";
                echo "<td>" . price_format($confidence) . "</td>";
                echo "<td>" . $keterangan . "</td>";
                echo "</tr>";
...
function hitung_confidence(
    ...
    // Ensure $supp_xuy is a number
    if (!is_numeric($supp_xuy)) {
        throw new InvalidArgumentException("Expected a numeric value for \$supp_xuy, got " . gettype($supp_xuy));
    }
